      ...
      <div className="w-full px-4 sm:px-6 lg:px-24 xl:px-40 flex flex-col items-start">
        ...
        <div className="w-full relative z-30">
          ...
          <h1 className="w-full grid grid-cols-[auto_1fr] tracking-[0.005em] text-white uppercase leading-[0.75] gap-x-[1vw] sm:gap-x-[1vw] xl:gap-x-[0.5vw]">
            ...
            <div 
              className="col-span-1 flex flex-col justify-end text-[clamp(8.5rem,-2.6229508197rem+28.8524590164vw,32rem)] font-humane font-black whitespace-nowrap text-left mb-[2vw] sm:mb-[0.5vw]"
            >
              {lang === 'PL' ? 'SOLIDNY' : 'SOLID'}
            </div>

            {/* Usługi - Zawsze po prawej stronie od SOLIDNY w tej samej linii */}
            <div className="col-span-1 flex flex-col justify-end pb-[5.5vw] sm:pb-[3.5vw] lg:pb-[3.2vw] xl:pb-[3vw] font-inter-tight text-white/90 normal-case whitespace-nowrap text-left text-[1.8vw] sm:text-[1.3vw] lg:text-[1vw] xl:text-[0.85vw] leading-[1.4] font-light min-w-0">
              {lang === 'PL' ? (
            ...
            <div className="col-span-2 text-[clamp(8.5rem,-2.6229508197rem+28.8524590164vw,32rem)] font-humane font-black whitespace-nowrap text-right flex justify-end items-end w-full relative">
