...
function HeroContent() {
  return (
    <div className="relative min-h-[125vh] lg:min-h-[calc(100vh+40px)] flex flex-col lg:flex-row items-start lg:items-center pt-32 lg:pt-0 pb-12 lg:pb-0 overflow-hidden z-0">
      <div className="w-full px-4 sm:px-6 lg:px-24 xl:px-40 relative z-20">
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          <motion.div 
            ...
            className="lg:col-span-5 flex justify-center lg:justify-end pt-8 lg:pt-0"
          >
            <PhoneMockup />
          </motion.div>
        </div>
  ...
  return (
    <div className="relative bg-[#f8fafc] font-sans text-slate-900 selection:bg-blue-100 selection:text-blue-900">
      ...
      <main className="relative">
        <div className="sticky bottom-0 lg:bottom-auto lg:top-0 w-full z-0">
          <Hero />
        </div>
