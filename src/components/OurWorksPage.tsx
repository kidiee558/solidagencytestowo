...
export const OurWorksPage = ({ onBack, onStartProjectClick, onAskAwayClick, initialProjectId }: { 
  ...
  const categories: Project[] = [
    ...
    },
    {
      ...
      title: lang === 'PL' ? 'Rozbudowana strona dla kliniki medycyny estetycznej' : 'Extended Website for Aesthetic Medicine Clinic',
    ...
    return (
      <div className="min-h-screen bg-[#050505] text-white pt-20">
        ...
        <div className="px-6 lg:px-[6.25rem] mb-12">
          <h2 className="text-white text-[clamp(1.5rem,3vw,2.5rem)] font-inter-tight font-light tracking-tight text-center max-w-4xl mx-auto">
      ...
      {categories.map((cat, idx) => (
        <div key={idx} className="w-full px-6 lg:px-[6.25rem] mb-32">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            <h3 className="text-white text-[clamp(1.5rem,2.5vw,2.25rem)] font-inter-tight font-light leading-tight">
              {cat.title}
            </h3>
            <button 
