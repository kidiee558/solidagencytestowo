...
export function AboutPage({ onBack, onContactClick, onOfferClick, onWebsitesClick }: { onBack: () => void; onContactClick?: () => void; onOfferClick?: () => void; onWebsitesClick?: () => void }) {
    ...
    <div className="w-full bg-black min-h-screen">
                  ...
                  <div className="flex flex-col items-start w-full">
                    ...
                    >
                      <span className="flex flex-col items-center justify-center w-full" aria-hidden="true">
                        <div 
                          className="text-[clamp(7.5rem,22vw,32rem)] sm:text-[clamp(8.5rem,-2.6229508197rem+28.8524590164vw,32rem)] font-humane font-black text-white leading-[0.75] uppercase tracking-[0.005em] text-center w-full relative"
      ...
      <section className="latest-news py-24 bg-white relative overflow-hidden" id="latest-news">
        <div className="w-full relative z-10 px-4 sm:px-6 lg:px-8">
          ...
          <div className="slider-news" style={{ 
            ...
            <div className="slider-news__viewport" style={{ overflowX: 'auto', scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
              <div className="slider-news__container flex items-start touch-pan-y" style={{ transform: 'translate3d(0px, 0px, 0px)', marginLeft: 'calc(1rem * -1)' }}>
                {[
                  ...
                  <div key={idx} className="slider-news__slide min-w-0 pl-[1rem]" style={{ flex: `0 0 ${100 / (typeof window !== 'undefined' && window.innerWidth > 1200 ? 4 : typeof window !== 'undefined' && window.innerWidth > 900 ? 3 : typeof window !== 'undefined' && window.innerWidth > 600 ? 2 : 1)}%` }}>
                    <a href={item.link} onClick={(e) => { e.preventDefault(); }} className="news-card block rounded-[20px] overflow-hidden flex flex-col bg-[#000] text-[#fff] border border-[rgba(255,255,255,0.25)] h-[24.375rem] select-none group relative">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6 px-4 sm:px-6 lg:px-8 mt-12">
            <div className="flex gap-4 w-full sm:w-auto justify-center sm:justify-start">
              <button className="w-14 h-14 rounded-full border border-black/20 flex items-center justify-center hover:bg-black/5 transition-colors">
            ...
            <button className="flex items-center justify-center gap-2 text-black font-medium hover:opacity-70 transition-opacity whitespace-nowrap underline underline-offset-4 sm:no-underline w-full sm:w-auto">
      ...
      <section className="min-h-screen bg-white text-black flex flex-col items-center justify-between p-6 relative overflow-hidden">
        ...
        <div className="relative z-20 flex flex-col items-center text-center mt-auto mb-auto px-6 translate-y-20 sm:translate-y-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <button onClick={onContactClick} className="rounded-full border border-black/20 hover:bg-black/5 transition-colors w-full sm:w-auto min-w-[12.5rem] h-[3.625rem] flex items-center justify-center">{lang === 'PL' ? 'Wystartuj teraz' : 'Start now'}</button>
            <button className="rounded-full border border-black/20 hover:bg-black/5 transition-colors w-full sm:w-auto min-w-[12.5rem] h-[3.625rem] flex items-center justify-center">{lang === 'PL' ? 'Pytaj śmiało!' : 'Ask away!'}</button>
          </div>
        </div>
