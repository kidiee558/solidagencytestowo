    ...
    <div className="relative z-40 bg-black text-white min-h-screen">
      ...
      <section className="relative z-10 w-full bg-black text-center pt-0 pb-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-[100rem] mx-auto">
          <h2 className="text-white font-inter-tight font-light leading-[1.05] tracking-tight mb-8" style={{ fontSize: 'clamp(2.5rem, 3vw, 4rem)' }}>
            {lang === 'PL' ? 'Prezentacja produktów w wymiarze 3D' : '3D Product Presentation'}
          </h2>
          <p className="text-white/80 text-[1rem] sm:text-lg lg:text-xl font-inter-tight font-light leading-relaxed max-w-4xl mx-auto mb-16 px-4">
            {lang === 'PL' 
