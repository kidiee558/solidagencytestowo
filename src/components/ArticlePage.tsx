...
export function ArticlePage({ onContactClick, onAskAwayClick, articleId = 'ux-design', onArticleClick, onStartProjectClick }: { onContactClick: () => void; onAskAwayClick: () => void; articleId?: string; onArticleClick?: (id: string) => void; onStartProjectClick?: () => void }) {
  const { lang } = useLanguage();
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-gray-400 mb-12 font-inter-tight">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-full bg-zinc-800 overflow-hidden">
              <img src="https://github.com/kidiee558/solidagencytestowo/blob/main/logosolidagency.webp?raw=true" alt="Solid Agency Logo" className="w-full h-full object-contain" />
            </div>
