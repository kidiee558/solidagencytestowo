...
export function PoradnikPage({ onBack, onArticleClick }: { onBack: () => void, onArticleClick: (id: string) => void }) {
    ...
    <div className="min-h-screen bg-black text-white">
      <div className="relative h-screen w-full overflow-hidden">
        ...
        <div className="absolute inset-0 z-[2] flex flex-col items-center justify-center">
          <h1 className="text-5xl md:text-7xl font-syne font-bold text-white tracking-tighter mb-6">{lang === 'PL' ? 'NASZ PORADNIK' : 'OUR GUIDE'}</h1>
